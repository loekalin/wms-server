...
class ReceivesController extends Controller
{
    public function index()
    {
        ...
        ->select('p.product_name as name' , 'sc.subcategory_name as sub_category' , 'receivings.receiving_uuid as uuid', 'st.satuan_name as satuan', 'receivings.receiving_date as date')
        ->paginate(10);
